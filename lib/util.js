...
exports.isInstanceOfElement = exports.nodeToBase64 = exports.nodeToDataURL = exports.svgToBase64 = exports.svgToDataURL = exports.createImage = exports.canvasToBlob = exports.checkCanvasDimensions = exports.getPixelRatio = exports.getImageSize = exports.toArray = exports.delay = exports.uuid = exports.resolveUrl = void 0;
...
function svgToBase64(svg) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, Promise.resolve(window.btoa(s))];
        });
    });
}
exports.svgToBase64 = svgToBase64;
function createSvg(node, width, height) {
...
function nodeToDataURL(node, width, height) {
    return __awaiter(this, void 0, void 0, function () {
        var svg;
        return __generator(this, function (_a) {
            svg = createSvg(node, width, height);
            return [2 /*return*/, svgToDataURL(svg)];
        });
    });
}
exports.nodeToDataURL = nodeToDataURL;
function nodeToBase64(node, width, height) {
    return __awaiter(this, void 0, void 0, function () {
        var svg;
        return __generator(this, function (_a) {
            svg = createSvg(node, width, height);
            return [2 /*return*/, svgToBase64(svg)];
        });
    });
}
exports.nodeToBase64 = nodeToBase64;
